...
if($_POST["hdProcess"]!="") {
	...
	$strSqlSelect = "SELECT * FROM ".TBL_FORTHCOMING_EXAMS." WHERE vTitle='".trim($cnf->strreplace($_POST["txtExamName"]))."'";

	if($cnf->records_fetch($strSqlSelect)==true) {

		header("Location:addexam.php?act=exists");
		...
		$fieldarray = array(		
			...
			$cnf->insert(TBL_FORTHCOMING_EXAMS,$fieldarray);

			header("Location:exams.php?act=added");
...
function valdateAdd(frm){
	var result = true;
	if(result) result = validateRequired(frm.txtTitle, 'Please enter the exam name');
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span><a href="exams.php">Manage Category</a></span></li>
										...
										<form action="" method="POST" class="form-horizontal form-bordered" name="frm" onSubmit="return valdateAdd(this)">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													...
													<input type="text" name="txtExamName" id="txtExamName" class="form-control" value="">
											...
											<div class="form-group">
												...
												<div class="col-md-6">
													<div class="input-group">
														...
														<input type="text" data-plugin-datepicker class="form-control" name="txt_start_date" id="txt_start_date" value="">
													</div>
												</div>
