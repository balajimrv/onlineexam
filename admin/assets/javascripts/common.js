...
function CheckImgExtension(field, msg){
	...
	var ext = field.value.split(".")
	if((ext[1] == 'jpg') || (ext[1] == 'JPG') || (ext[1] == 'jpeg') || (ext[1] == 'png') || (ext[1] == 'gif')){
		return true;
	}
	else {
		if (msg != ''){
...
function decimalNumbersOnly(myfield, e, dec) {
  var key;
  var keychar;
