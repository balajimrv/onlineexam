...
<div class="col-md-12 table-responsive">
       ...
       <table class="table table-bordered table-striped table-condensed" style="width:100%">  
		<tr>
            ...
            <td colspan="2"><h3>Customer Details</h3></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2"><h3>Orders List</h3></td>
          </tr>
		  <tr>
			...
			<table width="647" border="1" cellpadding="0" cellspacing="0" class="table table-bordered table-condensed">
			  <tr>
				<td width="245" height="28"><strong>Book Name</strong></td>
				<td width="66"><strong>Language</strong></td>
				<td width="165"><strong>Category</strong></td>
				<td width="58"><strong>Quantity</strong></td>
