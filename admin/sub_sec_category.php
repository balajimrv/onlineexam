...
if ($_REQUEST["page"]=="")
	...
	############# Active #############
				if($_GET["act"]=="btnActive") {
					...
					if($cnf->records_fetch($strSqlActive)==true) {
						...
						header("Location:sub_sec_category.php?act=".$actmsg.$url_fields);
						} else {
						header("Location:sub_sec_category.php?act=Invalid".$url_fields);
					}
				}		
	...
	if($_REQUEST['act']== 'delete'){
		...
		$sqlTest = mysqli_query($con, "SELECT test_id FROM `".TBL_TEST."` WHERE intSubCatId=".$_GET["id"]."");
		while($rowTest = mysqli_fetch_object($sqlTest)){
			$sqlQ = "DELETE FROM ".TBL_QUESTIONS." WHERE test_id=".$rowTest->test_id."";
			$cnf->query_execute($sqlQ);
			
			$strTest = "DELETE from ".TBL_TEST." WHERE test_id=".$rowTest->test_id."";
		...
		header("Location:sub_sec_category.php?act=deleted");
	}
...
if($_POST["btnSubmit"]!="") {		
				...
				$selOptions = $_POST["selOptions"];					
					...
					header("Location:sub_sec_category.php?act=".$strString."&rec=mul");
				}				
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						...
						<h2>Sub Secondary Category - List</h2>
						...
						<div class="right-wrapper pull-right">
							...
							<ol class="breadcrumbs">
								...
								<li><span><a href="addsub_sec_category.php">Add Sub Secondary Category</a></span></li>
							...
							<div class="col-lg-12">
								...
								<section class="panel">
                                    ...
                                    <form action="" method="POST" class="form-horizontal form-bordered" name="frm" onSubmit="return frmAction(frm);">
										...
										$strQry = "SELECT * FROM `".TBL_CATEGORY."` WHERE sub_sec_category!=0 ORDER BY `intCat_id` DESC";
                                            ...
                                            <table class="table table-bordered table-striped mb-none" id="datatable-default">
												...
												?>
                                                    ...
                                                    <tr class="gradeX">
														...
														<td>
                                                        <?php 
														$strSqlCat = "select vCatName from ".TBL_CATEGORY." where intCat_id='".$rowQry->sub_sec_category."'";
                                                        ...
                                                        <td>
                                                        <?php 
														$strSqlCat = "select vCatName from ".TBL_MAIN_CATEGORY." where intSubCatId='".$rowQry->intSubCatId."'";
														$resSqlCat = mysqli_query($con,$strSqlCat);
														$rowSqlCat = mysqli_fetch_object($resSqlCat);
														echo $rowSqlCat->vCatName;
														?>
                                                        ...
                                                        <td class="center"><?php echo $cnf->getActiveImageHide($rowQry->cStatus,'sub_sec_category.php?act=btnActive&id='.$rowQry->intCat_id)?></td>

                                                        <td class="center">

                                                        	
                                                            <a href="edit_sub_sec_category.php?id=<?php echo $rowQry->intCat_id.$url_fields ?>" onClick="return confirmMsg(1);" class="text-info" title="Edit"><i class="fa fa-pencil" ></i></a>&nbsp;&nbsp;
                                                            
                                                            <a href="sub_sec_category.php?act=delete&id=<?php echo $rowQry->intCat_id.$url_fields ?>" onClick="return confirmMsg(2);" class="text-danger" title="Delete"><i class="fa fa-trash-o"></i></a>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="rgtlistbdr">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="200" align="left" valign="middle">
                                                        ...
                                                        <a href="sub_sec_category.php?act=<?php echo $strCheck?>" class="text_btm_link"><?php echo $strCheckString?></a>
